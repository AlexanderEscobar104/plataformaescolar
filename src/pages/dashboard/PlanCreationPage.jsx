...
const MODULE_OPTIONS = [
  ...
  { key: 'desempeno', label: 'Desempeno', route: '/dashboard/desempeno' },
  { key: 'desempeno-periodos', label: 'Periodos de desempeno', route: '/dashboard/desempeno/periodos' },
  { key: 'desempeno-plantillas', label: 'Plantillas de desempeno', route: '/dashboard/desempeno/plantillas' },
  { key: 'desempeno-asignaciones', label: 'Asignaciones de desempeno', route: '/dashboard/desempeno/asignaciones' },
  { key: 'desempeno-evaluaciones', label: 'Evaluaciones de desempeno', route: '/dashboard/desempeno/evaluaciones' },
  { key: 'desempeno-resultados', label: 'Resultados de desempeno', route: '/dashboard/desempeno/resultados' },
  { key: 'desempeno-planes-mejora', label: 'Planes de mejora', route: '/dashboard/desempeno/planes-mejora' },
  { key: 'desempeno-historial', label: 'Historial de desempeno', route: '/dashboard/desempeno/historial' },
  { key: 'desempeno-reportes', label: 'Reportes de desempeno', route: '/dashboard/desempeno/reportes' },
  { key: 'desempeno-mi-desempeno', label: 'Mi desempeno', route: '/dashboard/desempeno/mi-desempeno' },

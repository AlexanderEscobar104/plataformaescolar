...
function RoleMembersListPage() {
  ...
  const canViewMembers = hasDynamicMembersModule && hasPermission(buildDynamicMemberPermissionKey(roleId, 'view'))
  const canCreateMembers = hasDynamicMembersModule && hasPermission(buildDynamicMemberPermissionKey(roleId, 'create'))
  const canEditMembers = hasDynamicMembersModule && hasPermission(buildDynamicMemberPermissionKey(roleId, 'edit'))
  const canDeleteMembers = hasDynamicMembersModule && hasPermission(buildDynamicMemberPermissionKey(roleId, 'delete'))

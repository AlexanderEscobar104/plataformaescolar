...
import ProfileSecurityPage from '../pages/dashboard/ProfileSecurityPage'
  ...
  return (
    <DashboardLayout>
      <Routes>
        ...
        <Route path="crear-estudiantes" element={<StudentsListPage />} />
        <Route path="crear-estudiantes/nuevo" element={<RoleRegistrationPage role="estudiante" title="Crear estudiantes" />} />
        <Route path="crear-estudiantes/editar/:studentId" element={<StudentEditPage />} />
        <Route path="crear-profesores" element={<ProfessorsListPage />} />
        <Route path="crear-profesores/nuevo" element={<RoleRegistrationPage role="profesor" title="Crear profesores" />} />
        ...
        <Route path="crear-directivos/nuevo" element={<RoleRegistrationPage role="directivo" title="Crear directivos" />} />
        ...
        <Route path="acudiente/eventos" element={<EventsPage />} />
        ...
        <Route path="solicitar-permiso" element={<PermisosPage />} />
        ...
        <Route path="evaluaciones/calificar" element={<EvaluationGradingPage />} />
        <Route path="evaluaciones/en-linea/:evaluationId" element={<EvaluationOnlineStatusPage />} />
        <Route path="evaluaciones/realizar/:evaluationId" element={<EvaluationTakePage />} />
        <Route path="horario" element={<SchedulePage />} />
        <Route path="crear-asignaturas" element={<SubjectsPage />} />
        <Route path="cargue-masivo" element={<SimpleModulePage title="Cargue masivo" description="Realiza cargues masivos de informacion academica." />} />
        ...
        <Route path="datos-plantel" element={<PlantelDataPage />} />
        <Route path="permisos" element={<PermissionsPage />} />
        <Route path="roles" element={<RolesPage />} />
        <Route path="tipo-reportes" element={<Navigate to="/tipo-reportes" replace />} />
        ...
        <Route path="creacion-planes" element={<Navigate to="/creacion-planes" replace />} />
        ...
        <Route path="perfil" element={<ProfileSecurityPage />} />

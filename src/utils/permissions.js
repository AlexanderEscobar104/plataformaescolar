const PERMISSION_KEYS = {
  ...
  SEDES_VIEW: 'sedes_view',
  SEDES_MANAGE: 'sedes_manage',
  ...
  PAYMENTS_PLATFORMS_MANAGE: 'payments_platforms_manage',
  ...
  MATRICULAS_VIEW: 'matriculas_view',
  MATRICULAS_MANAGE: 'matriculas_manage',
...
const PERMISSIONS_CATALOG = [
  ...
  {
    group: 'Plantel',
    key: PERMISSION_KEYS.SEDES_VIEW,
    label: 'Ver sedes',
    description: 'Permite consultar el modulo de sedes del plantel.',
  },
  {
    group: 'Plantel',
    key: PERMISSION_KEYS.SEDES_MANAGE,
    label: 'Gestionar sedes',
    description: 'Permite crear, editar, activar e inactivar sedes.',
  },
  {
    group: 'Academico',
  ...
  {
    group: 'Pagos',
    key: PERMISSION_KEYS.PAYMENTS_PLATFORMS_MANAGE,
    label: 'Configuracion de plataformas',
    description: 'Permite administrar las credenciales y la configuracion de plataformas de pago y facturacion.',
  },
  {
    group: 'Pagos',
  ...
  {
    group: 'Matriculas',
    key: PERMISSION_KEYS.MATRICULAS_VIEW,
    label: 'Ver modulo de matriculas',
    description: 'Permite consultar el estado de matricula por estudiante y ano lectivo.',
  },
  {
    group: 'Matriculas',
    key: PERMISSION_KEYS.MATRICULAS_MANAGE,
    label: 'Gestionar matriculas',
    description: 'Permite actualizar estados, registrar renovaciones y editar datos de matricula.',
  },
  {
    group: 'WhatsApp',
